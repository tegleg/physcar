...
class TESTCAR_API UMyMeshComponent : public UMeshComponent
{
	GENERATED_BODY()
...
public:
	...
	UMyMeshComponent(const FObjectInitializer& ObjectInitializer);
...
private:
	...
	static void SolveDistanceConstraint(FMeshParticle& ParticleA, FMeshParticle& ParticleB, float DesiredDistance);
	...
	TArray<FMeshParticle>	Particles;
